// Rubric for brownfield-expert-light scenario.
// Usage: bun tests/scenarios/brownfield-expert-light/rubric.ts <project-dir>
...
const SCENARIO = "brownfield-expert-light";
