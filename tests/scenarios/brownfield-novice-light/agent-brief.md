...
User message 1: "I have an existing project here that uses maestro. I want to add a CSV export feature to the reporting module."

User message 2: "Go ahead and work on it."

User message 3: "Looks good. Ship it."
...
```bash
bun <MAESTRO_CHECKOUT>/tests/scenarios/brownfield-novice-light/rubric.ts <SANDBOX_PATH>
```
