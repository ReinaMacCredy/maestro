...
const RESOURCE_VERSION_GUARD: [(&str, &str, &str, &str); 9] = [
    (
        ...
        "maestro-task",
        "1.9.1",
        "03684f8de668b3be5a08434e2e32abfc947757a34bb10f20027a036094eef495",
    ),
    (
        "skill",
        "maestro-feature",
        "1.6.0",
        "9b313e827609ef8de35bc16595bd4e7c74fd49aca01a0177a7daaf4f9b9c39e4",
    ),
    (
        "skill",
        "qa-baseline",
        "1.1.1",
        "a654079d190639a0041c1c6c4b28ebcfbe848260d0fbe9a4ca9fae1358a375c4",
    ),
    (
        "skill",
        "qa-slice",
        "1.1.1",
        "cb09e6a87c0faafb08eee8a757c65a20a9005db89743c119c0720c32a2fad68d",
    ),
    (
        "skill",
        "maestro-setup",
        "1.4.1",
        "51ea1ecf2ff1203b14aa315d6d5e06f357393c33fcbba3b3920abac695be2519",
    ),
    (
        "skill",
        "maestro-verify",
        "1.5.1",
        "9fb46f9cef96734f31caf35b8c49d5f93fe75b42bc518d483ed4c513c1d5b921",
    ),
    (
        "skill",
        "maestro-design",
        "1.4.1",
        "5cf4623015f770e5361429ccd1e3eceaf9922e709e9adb72ed6a0aa1301213a9",
    ),
    (
        "hook",
        "record.sh",
