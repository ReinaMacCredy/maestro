...
use $crate::domain::vnext::distribution::{CommitmentV1, ResourceDispositionV1};
use $crate::domain::vnext::identity::StoreObjectIdV1;
use $crate::domain::vnext::installation::{
    CutoverDomainBindingV1, DomainCurrentnessV1, HostActivationEntryV1, HostAdmissionStateV1,
    InstallationCensusClassV1, InstallationCensusEntryV1, InstallationCensusHeaderV1,
    InstallationCensusV1, InstallationCutoverErrorV1, ObservedHostActivationV1,
    ObservedInstallationClosureV1, UserAgentInstallationClosureV1, assess_user_agent_currentness,
};
use $crate::domain::vnext::migration::{
    CutoverCommitmentV1, CutoverDomainRefV1, CutoverDomainV1,
};
...
fn observed(closure: &UserAgentInstallationClosureV1) -> ObservedInstallationClosureV1 {
    ...
    ObservedInstallationClosureV1 {
        ...
        hosts: vec![ObservedHostActivationV1 {
            ...
            mcp_cli_search_descriptor_claim_ref: host.mcp_cli_search_descriptor_claim_ref.clone(),
...
fn read_only_census_materializes_the_exact_declared_root_closure() {
    ...
    let entry = InstallationCensusEntryV1 {
        ...
        custody_class:
            $crate::domain::vnext::distribution::runtime::TargetCustodyClassV1::MaestroOwnedTarget,
...
fn unmanaged_census_entry_cannot_carry_a_claim_or_receipt() {
    ...
    let entry = InstallationCensusEntryV1 {
        ...
        custody_class:
            $crate::domain::vnext::distribution::runtime::TargetCustodyClassV1::Unmanaged,
        unmanaged_reason: Some(
            $crate::domain::vnext::distribution::runtime::UnmanagedReasonV1::Foreign,
        ),
        resource_id: None,
        bundle_id: None,
        release_id: None,
        ...
        receipt_ref: None,
        content_sha256: None,
        alias_closure_ref: scoped(&domain, DistributionRuntimeObjectKindV1::AliasClosure, 48),
        consumer_refs: vec![],
        disposition: ResourceDispositionV1::Retain,
    };
