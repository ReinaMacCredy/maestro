...
use crate::domain::gate::{GateError, GateEvaluationResultV1, GateScopeV1, GateSnapshotV1};
...
impl<'store> EvidenceStoreFacadeV1<'store> {
    ...
    pub fn publish_observation(
        ...
        if let Some((run_id, owner)) = plan.observation.acquisition().run_binding()
            && !crate::domain::execution::store::current_run_binding_is_persisted(
...
fn validate_security_erasure_preparation(
    view: &crate::domain::persistence::StorePublicationViewV1<'_>,
...
pub(crate) fn validate_work_completion_evidence(
    ...
    generation: &StoreGenerationV1,
    objects: &[StoreObjectV1],
    work_id: crate::domain::work::WorkIdV1,
    contract_generation_id: crate::domain::contract::runtime::ContractGenerationIdV1,
    contract_root_id: crate::domain::identity::ContractRootIdV1,
    gate_snapshot: &GateSnapshotV1,
...
mod tests {
    ...
    use crate::domain::evidence::identity;
    ...
    fn actor_producer() -> crate::domain::authority::ExecutionProducerV1 {
        crate::domain::authority::ExecutionProducerV1::SessionBound {
    ...
    fn authority_for(
        selection: crate::domain::authority::RepositoryAuthoritySelectionV1,
        request: &CanonicalEvidenceActionRequestV1,
        actor: PrincipalIdV1,
    ...
    fn authorized_store_cut_and_security_erasure_are_restart_safe() {
        ...
        let gate_snapshot = GateSnapshotV1::new(
            ...
            contract_generation_id,
            contract_root,
            crate::domain::identity::ContractComponentIdV1::parse(&rendered(24)).unwrap(),
            digest(25),
            digest(26),
        ...
        let forged_session_observation = ObservationV1::new(ObservationDraftV1 {
            ...
            store_domain_id: domain.id(),
            subjects: observation.subjects().to_vec(),
            producer: crate::domain::authority::ExecutionProducerV1::SessionBound {
                principal_id: PrincipalIdV1::derive("stage3-actor-principal").unwrap(),
        ...
        assert!(retained_backup.export().entries().iter().any(|entry| {
            matches!(entry, crate::domain::persistence::SealedExportEntryV1::Available(object)
        ...
        assert!(post_erasure_backup.export().entries().iter().any(|entry| {
            matches!(entry, crate::domain::persistence::SealedExportEntryV1::Tombstoned(object)
