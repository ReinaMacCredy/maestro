...
use crate::domain::authority::{ActionRequestIdV1, AuthorizationReceiptV1, RepositoryActionLeafV1};
use crate::domain::identity::{CollectionPlanIdV1, LogicalTombstoneIdV1, StoreObjectIdV1};
...
pub struct SecurityErasureIntentV1 {
    ...
    authorization_receipt_id: crate::domain::authority::AuthorizationReceiptIdV1,
...
impl SecurityErasureIntentV1 {
    ...
    pub(crate) fn from_canonical_value(value: &CborValue) -> Result<Self, SecurityErasureError> {
        ...
        let intent = Self {
            ...
            authorization_receipt_id:
                crate::domain::authority::AuthorizationReceiptIdV1::from_digest(exact_digest(
                    authorization_receipt_id,
                )?),
...
pub enum SecurityErasureError {
    ...
    #[error(transparent)]
    ActionResult(#[from] crate::domain::authority::ActionResultError),
