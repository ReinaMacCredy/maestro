...
pub(in crate::domain) struct Stage11PreStoreFinalitySeedV1 {
    _private: (),
}
...
impl PreStoreFinalityOwnerV1 for Stage11PreStoreFinalitySeedV1 {
    ...
    fn final_recheck(
        ...
        _expected: InstallationFinalityCurrentnessV1,
        _request: &PreStoreFinalityRequestV1,
        _outcome: crate::domain::persistence::protected_locator_lease::ProtectedLocatorFinalityDispositionV1,
    ) -> Result<(), DurableInstallationFinalityErrorV1> {
        Err(DurableInstallationFinalityErrorV1::BackendUnavailable)
    }
}
...
pub(in crate::domain) struct Stage11PreStoreFinalitySeedV2 {
...
impl PreStoreFinalityOwnerV2 for Stage11PreStoreFinalitySeedV2 {
    ...
    fn final_recheck(
        &mut self,
        request: &PreStoreFinalityRequestV2,
        _disposition: crate::domain::persistence::protected_locator_v2::ProtectedLocatorFinalityDispositionV2,
