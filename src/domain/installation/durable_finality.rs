...
use crate::domain::persistence::protected_locator_lease::{
...
pub(in crate::domain) mod owner_sealed {
    pub trait Sealed {}
}

pub(in crate::domain) struct ActiveStoreFinalityRequestV2 {
...
impl ActiveStoreFinalityRequestV2 {
    pub(in crate::domain::installation) fn from_stage9_owner(
        currentness: InstallationFinalityCurrentnessV1,
        decision: ActiveStoreDecisionTupleV1,
    ...
    pub(in crate::domain::installation) fn consume_stage9_owner_view(
        &self,
...
pub(in crate::domain) struct PreStoreFinalityRequestV2 {
...
#[derive(Eq, PartialEq)]
pub(in crate::domain) struct ActiveStoreCommittedReadbackV2 {
    currentness: InstallationFinalityCurrentnessV1,
    decision: ActiveStoreDecisionTupleV1,
    association: [u8; 32],
...
pub(in crate::domain::installation) struct ActiveStoreFinalityOwnerViewV2<'request> {
...
impl ActiveStoreFinalityOwnerViewV2<'_> {
    ...
    pub(in crate::domain::installation) fn validate_committed_readback(
        self,
        currentness: InstallationFinalityCurrentnessV1,
        decision: ActiveStoreDecisionTupleV1,
        association: [u8; 32],
...
pub(in crate::domain) enum ActiveStoreOwnerOutcomeV2 {
    PreCommitRefused,
...
pub(in crate::domain) struct PreStoreOwnerValidationV2 {
    pub(super) currentness: InstallationFinalityCurrentnessV1,
    pub(super) decision: PreStoreDecisionTupleV1,
...
pub(in crate::domain) trait ActiveStoreFinalityOwnerV2:
    owner_sealed::Sealed
{
...
pub(in crate::domain) trait PreStoreFinalityOwnerV2:
    owner_sealed::Sealed
{
...
pub(in crate::domain) enum DurableInstallationFinalityErrorV2 {
...
pub(in crate::domain) struct InstallationFinalityCurrentnessV1 {
...
pub(in crate::domain) struct ActiveStoreFinalityRequestV1 {
    pub(super) currentness: InstallationFinalityCurrentnessV1,
    pub(super) decision: ActiveStoreDecisionTupleV1,
}

pub(in crate::domain) struct PreStoreFinalityRequestV1 {
    pub(super) currentness: InstallationFinalityCurrentnessV1,
    pub(super) decision: PreStoreDecisionTupleV1,
}

#[derive(Clone, Copy, Eq, PartialEq)]
pub(in crate::domain) struct ActiveStoreDecisionTupleV1 {
...
#[derive(Clone, Copy, Eq, PartialEq)]
pub(in crate::domain) struct PreStoreDecisionTupleV1 {
    pub(super) operation: [u8; 32],
...
#[derive(Clone, Copy, Eq, PartialEq)]
pub(in crate::domain) struct ActiveStoreCommittedReadbackV1 {
    pub(super) currentness: InstallationFinalityCurrentnessV1,
    pub(super) decision: ActiveStoreDecisionTupleV1,
...
pub(in crate::domain) enum ActiveStoreOwnerOutcomeV1 {
    PreCommitRefused,
...
pub(in crate::domain) struct PreStoreOwnerValidationV1 {
    pub(super) currentness: InstallationFinalityCurrentnessV1,
    pub(super) decision: PreStoreDecisionTupleV1,
    pub(super) write_count: u64,
    _not_send_or_sync: PhantomData<Rc<()>>,
...
pub(in crate::domain) trait ActiveStoreFinalityOwnerV1:
    owner_sealed::Sealed
{
    fn prepare_request(
        &mut self,
...
pub(in crate::domain) trait PreStoreFinalityOwnerV1:
    owner_sealed::Sealed
{
    fn prepare_request(
        &mut self,
...
pub(in crate::domain) enum DurableInstallationFinalityErrorV1 {
...
mod tests {
    ...
    fn v2_pre_store_retains_the_real_locator_lease_and_stays_inert() {
        ...
        let (outcome, locator_writes) =
            crate::domain::persistence::protected_locator_lease::v2_tests::with_test_lease_v2(
                |lease| {
