...
use crate::domain::vnext::identity::{ContractRootIdV1, DesignFinalizationManifestIdV1};
use crate::domain::vnext::step::{StepGraphSnapshotV1, StepStateV1};
...
mod tests {
    ...
    fn identity<K>(byte: u8) -> crate::domain::vnext::identity::ManifestIdentityV1<K>
    where
        K: crate::domain::vnext::identity::IdentityKindV1,
    {
        crate::domain::vnext::identity::ManifestIdentityV1::parse(&format!(
            "sha256:{}",
