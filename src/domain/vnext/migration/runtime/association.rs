...
use crate::domain::vnext::execution::h3_withdrawal_publication::{
...
use crate::domain::vnext::migration::MigrationCutoverError;
...
pub(in crate::domain::vnext) struct H3NativeCancelledMigrationMemberV1<'tx> {
...
impl<'tx> H3NativeCancelledMigrationMemberV1<'tx> {
    pub(in crate::domain::vnext) fn bind(
        publication: VerifiedH3WithdrawalPublicationUseV1<'tx>,
        source_id: MigrationDigestV1,
        inventory: &ByteTotalInventoryV1,
        classifications: &ClassificationSetV1,
...
pub(in crate::domain::vnext) struct H3VerifiedMigrationAssociationUseV1<'tx> {
...
impl H3VerifiedMigrationAssociationUseV1<'_> {
    pub(in crate::domain::vnext) const fn association(&self) -> &MigrationAssociationV1 {
        &self.association
    }
}
