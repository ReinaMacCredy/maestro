...
pub struct ObservationAssessmentInputV1 {
    ...
    observed_at: u64,
    payload_object_id: crate::domain::vnext::identity::StoreObjectIdV1,
...
pub struct ClaimAssessmentInputV1 {
    ...
    payload_object_ids: Vec<crate::domain::vnext::identity::StoreObjectIdV1>,
...
pub struct AuthorizationAssessmentInputV1 {
    receipt_id: crate::domain::vnext::authority::AuthorizationReceiptIdV1,
    receipt_hash: [u8; 32],
    request_id: ActionRequestIdV1,
    context_id: crate::domain::vnext::authority::AuthorityContextIdV1,
    basis_kind: u8,
    prior_state_token: crate::domain::vnext::authority::StateTokenIdV1,
    resulting_state_token: crate::domain::vnext::authority::StateTokenIdV1,
...
impl AuthorizationAssessmentInputV1 {
    ...
    pub(crate) fn exact_receipt(&self) -> Result<AuthorizationReceiptV1, AssessmentError> {
        let basis_kind =
            crate::domain::vnext::authority::ActionAuthorityBasisKindV1::try_from(self.basis_kind)
...
impl EvidenceMutationAuthorityV1 {
    pub(crate) fn from_admitted_action(
        ...
        request_object: &crate::domain::vnext::persistence::StoreObjectV1,
        evidence_cut_hash: [u8; 32],
    ) -> Result<Self, AssessmentError> {
...
pub struct AssessmentInvalidationV1 {
    ...
    authority_receipt_id: crate::domain::vnext::authority::AuthorizationReceiptIdV1,
...
impl AssessmentInvalidationV1 {
    ...
    pub(crate) const fn authority_receipt_id(
        &self,
    ) -> crate::domain::vnext::authority::AuthorizationReceiptIdV1 {
    ...
    match (*tag, fields.as_slice()) {
        ...
        (
            ...
            let value = AuthorizationAssessmentInputV1 {
                ...
                context_id: crate::domain::vnext::authority::AuthorityContextIdV1::from_digest(
                    exact_assessment_digest(context_id)?,
                ),
                basis_kind: u8::try_from(*basis_kind)
                    .map_err(|_| AssessmentError::InvalidStoredAssessment)?,
                prior_state_token: crate::domain::vnext::authority::StateTokenIdV1::from_digest(
                    exact_assessment_digest(prior_state_token)?,
                ),
                resulting_state_token: crate::domain::vnext::authority::StateTokenIdV1::from_digest(
...
pub enum AssessmentError {
    ...
    Gate(#[from] GateError),
    #[error(transparent)]
    StepIdentity(#[from] crate::domain::vnext::step::StepIdentityError),
    #[error(transparent)]
...
mod tests {
    ...
    use crate::domain::vnext::gate::{GateEvaluatorContractV1, GateLeafRuleV1, GateNodeV1};
    use crate::domain::vnext::identity::{
    ...
    use crate::domain::vnext::step::{StepIdV1, StepScopeV1, StepSubmissionIdV1};
    ...
    fn snapshot(roots: Vec<GateNodeIdV1>, nodes: Vec<GateNodeV1>) -> GateSnapshotV1 {
        GateSnapshotV1::new(
            ...
            crate::domain::vnext::identity::ContractComponentIdV1::parse(&rendered(4)).unwrap(),
            token(4),
            token(5),
            roots,
            nodes,
    ...
    fn security_erasure_is_authorized_and_couples_all_invalidations() {
        ...
        let receipt = publication
            .intent()
            .finalize(
                crate::domain::vnext::evidence::SecurityErasureFinalizationV1 {
    ...
    fn step_claim_subject_helper_remains_generation_scoped() {
        ...
        let binding = crate::domain::vnext::step::StepBindingV1::new(
            scope,
            ContractGenerationIdV1::parse(&rendered(2)).unwrap(),
            ContractRootIdV1::parse(&rendered(3)).unwrap(),
        ...
        let other_generation_binding = crate::domain::vnext::step::StepBindingV1::new(
            scope,
