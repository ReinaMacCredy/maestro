        ...
        McpPacketReadEnvelopeV1::NoActiveStore {
            ...
            "value": bootstrap_route_fact_view.as_ref().map(|view| json!({
                ...
                "bootstrap_context": match view.bootstrap_context {
                    crate::domain::vnext::integration::public_literals::BootstrapContextV1::RepositoryBootstrap => "RepositoryBootstrap",
                    crate::domain::vnext::integration::public_literals::BootstrapContextV1::InstallationBootstrap => "InstallationBootstrap",
                },
...
fn decode_action(value: &Value) -> Result<ActionRequestV1, TransportErrorV1> {
    ...
    Ok(ActionRequestV1 {
        ...
        action_spec: crate::domain::vnext::integration::public_literals::ActionSpecRefV1 {
...
fn decode_ceremony(value: &Value) -> Result<CeremonyRequestV1, TransportErrorV1> {
    ...
    Ok(CeremonyRequestV1 {
        ...
        idempotency_key: text_field(object, "idempotency_key")?,
        semantic_request_hash: digest_field(object, "semantic_request_hash")?,
        ceremony_spec: crate::domain::vnext::integration::public_literals::CeremonySpecRefV1 {
...
fn return_occurrence_value(
    occurrence: &crate::domain::vnext::orchestration::literals::RecipeReturnOccurrenceV1,
) -> Value {
    json!({
...
mod tests {
    ...
    fn action_request() -> OperationRequestV1 {
        let catalog =
            crate::domain::vnext::capability::generated_catalog::GeneratedCapabilityCatalogV1::load_frozen()
                .expect("catalog");
