...
fn historical_reconciliation_begin_requests(
    active_objects: &[StoreObjectV1],
    intent: EffectIntentIdV1,
) -> Result<Vec<crate::domain::vnext::authority::ActionRequestIdV1>, ExecutionStoreErrorV1> {
    let schema =
...
mod tests {
    ...
    use crate::domain::vnext::execution::runtime::{StepAttemptStateV1, TakeoverSafetyMechanismV1};
    use crate::domain::vnext::execution::withdrawal::RemoteClassificationV1;
        ...
        assert!(matches!(
            ...
            Err(
                crate::domain::vnext::evidence::ClaimError::SubmissionClaimSet(
                    crate::domain::vnext::evidence::SubmissionClaimSetError::Empty
                )
            )
        ));
    ...
    fn specialized_effect_authority_rejects_cross_basis_and_substituted_carriers_without_debit() {
        ...
        assert!(matches!(
            ...
            Err(
                crate::domain::vnext::authority::RepositoryLeafAuthorityErrorV1::ExecutionAuthorityBasisMismatch
            )
        ));
    ...
    fn effect_dispatch_control_cross_invariants_reject_individually_valid_mismatches() {
        ...
        let terminal_need = EffectControlTransitionNeedV1::FinishDispatch {
            action_request_id: crate::domain::vnext::authority::ActionRequestIdV1::from_digest(
                [110; 32],
            ),
            attempt: super::super::runtime::ExecutionAttemptOwnerV1::Dispatch(
    ...
    fn specialized_effect_terminal_plan(
        ...
        let phase_ordinal = usize::from(matches!(
            snapshot.dispatch().state(),
            crate::domain::vnext::execution::dispatch_state::DispatchAttemptStateV1::SealedInFlight(
                _
            )
        ));
