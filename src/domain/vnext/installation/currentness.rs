...
use crate::domain::vnext::distribution::ReleaseIdV1;
use crate::domain::vnext::distribution::runtime::DistributionScopedObjectRefV1;
...
pub struct ObservedHostActivationV1 {
    pub host_tag: u64,
    pub host_adapter_id: crate::domain::vnext::distribution::CommitmentV1,
