...
pub struct DecisionClosureRecordV1 {
    ...
    materialization_ids: Vec<crate::domain::vnext::identity::DecisionMaterializationIdV1>,
...
impl DecisionClosureRecordV1 {
    ...
    pub fn materialization_ids(
        &self,
    ) -> &[crate::domain::vnext::identity::DecisionMaterializationIdV1] {
...
impl DecisionClosureManifestV1 {
    pub fn close(
        ...
        initial_contract_root: &crate::domain::vnext::contract::root::CandidateContractRootV1,
...
fn derive_candidate_root(
    initial_root: &crate::domain::vnext::contract::root::CandidateContractRootV1,
    schemas: &SchemaClosureV1,
...
fn roots_equal_exact(
    left: &crate::domain::vnext::contract::root::CandidateContractRootV1,
    right: &crate::domain::vnext::contract::root::CandidateContractRootV1,
