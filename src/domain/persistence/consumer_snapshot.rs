...
pub(in crate::domain) enum ConsumerSnapshotCurrentFactsV1 {
    ActiveStore {
...
impl ConsumerSnapshotCurrentFactsV1 {
    ...
    pub(in crate::domain) const fn expected_old_cas(&self) -> [u8; 32] {
        match self {
    ...
    pub(in crate::domain) fn canonical_commitments(&self) -> Vec<[u8; 32]> {
        match self {
            Self::ActiveStore {
                owner_operation,
                store_instance,
    ...
    pub(in crate::domain) fn canonical_scalars(&self) -> Vec<u64> {
        match self {
            Self::ActiveStore {
                owner_stage_tag,
                generation_ordinal,
...
pub(in crate::domain::persistence) mod consumer_currentness_sealed {
    pub trait ProviderSealed {}
    pub trait LeaseSealed {}
}

pub(in crate::domain) trait ConsumerSnapshotCurrentViewProviderV1:
...
pub(in crate::domain) trait ConsumerSnapshotCurrentViewLeasePortV1:
...
pub(in crate::domain) struct ConsumerSnapshotCurrentViewLeaseV1<'view, L> {
    lease: L,
...
{
    pub(in crate::domain::persistence) fn bind(
        lease: L,
    ...
    pub(in crate::domain) fn initial(&self) -> &ConsumerSnapshotCurrentFactsV1 {
        &self.initial
    }

    pub(in crate::domain) fn recheck_current(
        &mut self,
    ) -> Result<ConsumerSnapshotCurrentFactsV1, ConsumerSnapshotCurrentnessErrorV1> {
...
pub(in crate::domain) enum ConsumerSnapshotCurrentnessErrorV1 {
