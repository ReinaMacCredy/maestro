...
pub(crate) struct VerifiedCollectionAbsenceV1 {
    tombstone_id: crate::domain::identity::LogicalTombstoneIdV1,
    collection_plan_id: crate::domain::identity::CollectionPlanIdV1,
...
impl VerifiedCollectionAbsenceV1 {
    pub(crate) const fn tombstone_id(self) -> crate::domain::identity::LogicalTombstoneIdV1 {
        self.tombstone_id
    }

    pub(crate) const fn collection_plan_id(self) -> crate::domain::identity::CollectionPlanIdV1 {
...
impl StoreV1 {
    ...
    pub(in crate::domain) fn admit_consumer_closure_durable_root_v1(
        &self,
    ) -> Result<
