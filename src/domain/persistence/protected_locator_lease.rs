...
impl ProtectedLocatorAcquisitionRequestV2 {
    ...
    pub(in crate::domain::persistence) fn from_stage9_owner(
        installation: [u8; 32],
        realm: [u8; 32],
        installation_domain: [u8; 32],
        operation: [u8; 32],
...
impl ProtectedLocatorCandidateInputV2 {
    ...
    pub(in crate::domain) fn from_installation_owner(
        installation: [u8; 32],
        realm: [u8; 32],
        ceremony_spec: [u8; 32],
        attempt: [u8; 32],
...
#[derive(Eq, PartialEq)]
pub(in crate::domain) struct ProtectedLocatorCandidateStateV2 {
...
impl ProtectedLocatorCandidateStateV2 {
    ...
    pub(in crate::domain::persistence) fn consume_stage9_dispatch_projection(
        &self,
...
pub(in crate::domain::persistence) struct ProtectedLocatorStage9DispatchProjectionV2<'candidate> {
...
impl ProtectedLocatorStage9DispatchProjectionV2<'_> {
    pub(in crate::domain::persistence) fn candidate_association(&self) -> &[u8; 32] {
        self.candidate_association
    }

    pub(in crate::domain::persistence) fn candidate_root(&self) -> &[u8; 32] {
        self.candidate_root
    }

    pub(in crate::domain::persistence) fn candidate_carrier(&self) -> &[u8; 32] {
        self.candidate_carrier
    }

    pub(in crate::domain::persistence) fn candidate_seal(&self) -> &[u8; 32] {
        self.candidate_seal
    }

    pub(in crate::domain::persistence) fn candidate_postcondition(&self) -> &[u8; 32] {
        self.candidate_postcondition
    }

    pub(in crate::domain::persistence) fn transition_commitment(&self) -> &[u8; 32] {
        self.transition_commitment
    }

    pub(in crate::domain::persistence) fn matches_exact_owner_effect(
        &self,
        candidate_association: &[u8; 32],
        candidate_root: &[u8; 32],
        candidate_carrier: &[u8; 32],
...
pub(in crate::domain) enum ProtectedLocatorDispatchOccurrenceV2 {
    Definite,
    Unknown,
...
#[derive(Eq, PartialEq)]
pub(in crate::domain) struct ProtectedLocatorFinalReadbackV2 {
...
impl ProtectedLocatorFinalReadbackV2 {
    pub(in crate::domain::persistence) fn exact_candidate_from_stage9_owner(
        request: &ProtectedLocatorAcquisitionRequestV2,
        observed: ProtectedLocatorObservedStateV2,
    ...
    pub(in crate::domain::persistence) fn observed_non_candidate_from_stage9_owner(
        request: &ProtectedLocatorAcquisitionRequestV2,
        observed: ProtectedLocatorObservedStateV2,
    ) -> Result<Self, ProtectedLocatorLeaseErrorV2> {
        validate_acquisition(request, &observed)?;
...
pub(in crate::domain) trait ProtectedLocatorBackendV2:
...
pub(in crate::domain) struct ProtectedLocatorLeaseV2<'locator> {
...
impl<'locator> ProtectedLocatorLeaseV2<'locator> {
    pub(in crate::domain::persistence) fn acquire(
        backend: &'locator mut dyn ProtectedLocatorBackendV2,
    ) -> Result<Self, ProtectedLocatorLeaseErrorV2> {
    ...
    pub(in crate::domain) fn bind_inert_candidate(
        self,
        candidate: ProtectedLocatorCandidateInputV2,
...
pub(in crate::domain) struct ProtectedLocatorCandidateTransitionV2<'locator> {
    backend: &'locator mut dyn ProtectedLocatorBackendV2,
    acquisition: ProtectedLocatorObservedStateV2,
    prepared: ProtectedLocatorCandidateStateV2,
    consumed: Cell<bool>,
...
impl ProtectedLocatorCandidateTransitionV2<'_> {
    pub(in crate::domain) fn dispatch(
        self,
...
pub(in crate::domain) enum ProtectedLocatorFinalityDispositionV2 {
    Committed,
    RecoveryRequired,
    InDoubt,
    IntegrityBlocked,
...
pub(in crate::domain) enum ProtectedLocatorLeaseErrorV2 {
...
#[cfg(test)]
pub(in crate::domain) mod v2_tests {
    use super::*;
    ...
    pub(in crate::domain) fn with_test_lease_v2<R>(
...
#[derive(Clone, Copy)]
pub(in crate::domain) struct ProtectedLocatorOperationRequestV1 {
    installation: [u8; 32],
    realm: [u8; 32],
    installation_domain: [u8; 32],
    operation: [u8; 32],
...
impl ProtectedLocatorOperationRequestV1 {
    ...
    pub(in crate::domain) fn from_installation_operation(
        installation: [u8; 32],
        realm: [u8; 32],
        installation_domain: [u8; 32],
        operation: [u8; 32],
...
pub(in crate::domain::persistence) trait ProtectedLocatorBackendV1:
    owner_sealed::Sealed
{
...
pub(in crate::domain) struct ProtectedLocatorLeaseV1<'locator> {
...
impl<'locator> ProtectedLocatorLeaseV1<'locator> {
    ...
    pub(in crate::domain) fn begin_pre_store(
        self,
...
#[derive(Clone, Copy)]
pub(in crate::domain) struct ProtectedLocatorPreStoreJoinV1 {
    installation: [u8; 32],
    realm: [u8; 32],
    installation_domain: [u8; 32],
    operation: [u8; 32],
...
pub(in crate::domain) struct ProtectedLocatorOperationJoinV1 {
    operation: [u8; 32],
    ceremony: [u8; 32],
    attempt: [u8; 32],
    candidate_association: [u8; 32],
...
pub(in crate::domain) struct ProtectedLocatorOwnerJoinV1 {
    installation: [u8; 32],
    realm: [u8; 32],
    installation_domain: [u8; 32],
    facility: [u8; 32],
...
pub(in crate::domain) struct ProtectedLocatorCeremonyContinuationV1<'locator> {
...
#[derive(Clone, Copy, Eq, PartialEq)]
pub(in crate::domain) enum ProtectedLocatorFinalityDispositionV1 {
    Committed,
    RecoveryRequired,
    InDoubt,
    IntegrityBlocked,
...
pub(in crate::domain) enum ProtectedLocatorLeaseErrorV1 {
...
mod tests {
    ...
    fn pre_store_hands_the_live_lease_to_the_ceremony_cas_continuation() {
        let mut backend = backend();
        let lease = ProtectedLocatorLeaseV1::acquire(&mut backend, request()).unwrap();
        assert!(crate::domain::installation::consume_pre_store_with_test_owner(lease, 0));
        assert_eq!(backend.dispatches, 1);
    }
    ...
    fn pre_store_false_success_with_a_write_is_rejected_through_the_same_live_lease() {
        let mut backend = backend();
        let lease = ProtectedLocatorLeaseV1::acquire(&mut backend, request()).unwrap();
        assert!(!crate::domain::installation::consume_pre_store_with_test_owner(lease, 1));
        assert_eq!(backend.dispatches, 0);
    }
}
