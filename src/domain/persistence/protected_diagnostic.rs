...
impl ProtectedDiagnosticProviderCurrentnessV1 {
    ...
    pub(in crate::domain::persistence) fn from_live_provider(
        store_instance_binding: [u8; 32],
        activation_carrier_identity: [u8; 32],
        activation_carrier_token: [u8; 32],
        activation_carrier_revision: u64,
    ...
    pub(in crate::domain::persistence) fn matches(&self, other: &Self) -> bool {
...
pub(in crate::domain::persistence) mod sealed {
    pub(in crate::domain::persistence) trait Sealed {}
}
