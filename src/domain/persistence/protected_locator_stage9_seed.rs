...
pub(in crate::domain) struct Stage9ProtectedLocatorBackendSeedV2<'locator> {
...
pub(in crate::domain) fn acquire_stage9_backend_v2<'locator>(
    store: &'locator ProtectedCeremonyEffectStoreV1,
    anchor: &'locator ProtectedCeremonyCarrierAnchorV1,
    owner_authority: &'locator ProtectedCeremonyOwnerAuthorityV1,
...
pub(in crate::domain::persistence) fn acquire_protected_locator_lease_v2<'lease, 'provider>(
...
#[cfg(test)]
pub(in crate::domain::persistence) struct Stage9ProtectedLocatorBackendSeedV1 {
    _private: (),
}
...
#[cfg(test)]
pub(in crate::domain::persistence) fn acquire_stage9_backend() -> Stage9ProtectedLocatorBackendSeedV1
{
    Stage9ProtectedLocatorBackendSeedV1 { _private: () }
}

#[cfg(test)]
pub(in crate::domain::persistence) fn acquire_protected_locator_lease<'locator>(
...
mod tests {
    ...
    use crate::domain::execution::CeremonySpecV1;
