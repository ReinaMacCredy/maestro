...
impl SchedulingPolicyDiffClassV1 {
    pub(in crate::domain::authority) const fn requires_downgrade_mandate(self) -> bool {
        matches!(self, Self::Weakening | Self::Incomparable)
    }
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::domain::authority) struct SchedulingPolicyMeaningV1 {
    current_rules: [u64; 4],
...
impl SchedulingPolicyMeaningV1 {
    pub(in crate::domain::authority) fn new(
        current_rules: [u64; 4],
        candidate_rules: [u64; 4],
        safety_floor: [u64; 4],
        governance_floor_binding: [u8; 32],
    ...
    pub(in crate::domain::authority) const fn current_rules(self) -> [u64; 4] {
        self.current_rules
    }

    pub(in crate::domain::authority) const fn candidate_rules(self) -> [u64; 4] {
        self.candidate_rules
    }

    pub(in crate::domain::authority) const fn safety_floor(self) -> [u64; 4] {
        self.safety_floor
    }

    pub(in crate::domain::authority) const fn governance_floor_binding(self) -> [u8; 32] {
        self.governance_floor_binding
    }

    pub(in crate::domain::authority) const fn evaluator_revision(self) -> u64 {
        self.evaluator_revision
    }

    pub(in crate::domain::authority) const fn classifier_revision(self) -> u64 {
        self.classifier_revision
    }
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::domain::authority) struct SchedulingPolicyDowngradeMandateFactsV1 {
    pub(in crate::domain::authority) policy_meaning: SchedulingPolicyMeaningV1,
...
pub(in crate::domain::authority) struct AuthorityMaterializationTransactionV1<'tx> {
...
pub(in crate::domain::authority) trait MaterializationStoreViewPortV1 {
...
pub(in crate::domain::authority) trait MaterializationAtomicPublicationPortV1 {
...
impl<'tx> AuthorityMaterializationTransactionV1<'tx> {
    pub(in crate::domain::authority) fn from_live_store_transaction(
    ...
    pub(in crate::domain::authority) fn mint_mandate(
        &'tx self,
    ...
    pub(in crate::domain::authority) fn mint_binding<K: RepositoryActionBindingKindV1>(
        &'tx self,
    ...
    pub(in crate::domain::authority) fn consume_binding_without_mandate<
    ...
    pub(in crate::domain::authority) fn validate_atomic_publication(
        &self,
    ...
    pub(in crate::domain::authority) fn is_consumed(&self) -> bool {
...
pub(in crate::domain::authority) struct VerifiedSchedulingPolicyDowngradeMandateUseV1<'tx> {
    facts: SchedulingPolicyDowngradeMandateFactsV1,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::domain::authority) struct RepositoryActionCommitFactsV1 {
    pub(in crate::domain::authority) binding: RepositoryActionBindingFactsV1,
}

pub(in crate::domain::authority) struct ConsumedSchedulingPolicyDowngradeMandateV1<'tx> {
    _transaction: PhantomData<&'tx mut ()>,
    _not_send_or_sync: PhantomData<Rc<()>>,
}

pub(in crate::domain::authority) struct ConsumedRepositoryActionMaterializationV1<'tx> {
    _transaction: PhantomData<&'tx mut ()>,
    _not_send_or_sync: PhantomData<Rc<()>>,
}

impl<'tx> VerifiedSchedulingPolicyDowngradeMandateUseV1<'tx> {
    pub(in crate::domain::authority) fn consume_with_action_binding<
        K: RepositoryActionBindingKindV1,
    >(
        self,
...
pub(in crate::domain) trait RepositoryActionBindingKindV1:
    owner_sealed::Sealed
{
...
macro_rules! owner_binding_kind {
    ($type:ident, $authority:ty, $first:literal..=$last:literal, $future:meta) => {
        pub(in crate::domain) struct $type<const GLOBAL_TAG: u64>;
        ...
        impl<const GLOBAL_TAG: u64> $type<GLOBAL_TAG> {
            pub(in crate::domain) fn authority(
                selection: RepositoryAuthoritySelectionV1,
                subject_commitment: [u8; 32],
                current_semantic_owner_basis_commitment: [u8; 32],
                exact_payload_commitment: [u8; 32],
...
pub(in crate::domain) type SchedulingPolicyBindingOwnerV1 =
...
pub(in crate::domain::authority) struct AdmittedRepositoryActionBindingV1<'tx, K> {
    facts: RepositoryActionBindingFactsV1,
    admission: MaterializationAuthorityAdmissionV1,
    transaction: &'tx AuthorityMaterializationTransactionV1<'tx>,
...
pub(in crate::domain::authority) fn policy_commitment(domain: &[u8], rows: &[u64]) -> [u8; 32] {
...
pub(in crate::domain::authority) fn derive_policy_relation(
...
mod tests {
    ...
    fn test_admission(
        ...
        MaterializationAuthorityAdmissionV1 {
            ...
            basis_object_id: crate::domain::identity::StoreObjectIdV1::from_digest([51; 32]),
            current_snapshot_id: crate::domain::identity::StoreObjectIdV1::from_digest([52; 32]),
            successor_snapshot_id: crate::domain::identity::StoreObjectIdV1::from_digest([53; 32]),
            successor_store_generation: 2,
            current_capacity_root_id: crate::domain::identity::StoreObjectIdV1::from_digest(
                [54; 32],
            ),
            successor_capacity_root_id: crate::domain::identity::StoreObjectIdV1::from_digest(
                [55; 32],
            ),
            capacity_debit_id: crate::domain::identity::StoreObjectIdV1::from_digest([56; 32]),
            leaf_authority_carrier_id: Some(crate::domain::identity::StoreObjectIdV1::from_digest(
                [57; 32],
            )),
            leaf_authority_consumption_id: Some(
                crate::domain::identity::StoreObjectIdV1::from_digest([58; 32]),
            ),
            guard_object_id: crate::domain::identity::StoreObjectIdV1::from_digest([59; 32]),
            state_object_id: crate::domain::identity::StoreObjectIdV1::from_digest([60; 32]),
