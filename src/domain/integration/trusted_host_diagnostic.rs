...
use crate::domain::authority::TrustedHostDiagnosticChallengeV1;
#[cfg(test)]
...
pub(in crate::domain::integration) mod sealed {
    pub(in crate::domain::integration) trait Connection {}
    pub(in crate::domain::integration) trait Attestation {}
    pub(in crate::domain::integration) trait Presentation {}
}
