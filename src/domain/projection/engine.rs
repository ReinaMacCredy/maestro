...
#![allow(
    dead_code,
    reason = "the canonical projection engine remains crate-internal"
)]
...
fn project_packet(
    ...
    for _ in 0..4 {
        let encoded_len = crate::domain::transport::encoded_packet_len(&packet)?;
...
pub(crate) enum ProjectionErrorV1 {
    ...
    #[error(transparent)]
    Transport(#[from] crate::domain::transport::TransportErrorV1),
}
