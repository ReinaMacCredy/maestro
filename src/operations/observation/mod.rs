...
use crate::domain::authority::{AuthorityFacadeV1, ContinuityReferenceV1};
use crate::domain::capability::runtime::CapabilityViewV1;
use crate::domain::evidence::diagnostics::{
    OrdinaryDiagnosticViewV1, ProtectedDiagnosticEnvelopeV1,
};
use crate::domain::intake::IntakeProjectionV1;
use crate::domain::integration::TrustedHostDiagnosticConnectionPortV1;
use crate::domain::maturity::MaturityViewV1;
use crate::domain::memory::MemoryAdvisoryProjectionV1;
use crate::domain::persistence::ProtectedDiagnosticCurrentViewProviderV1;
use crate::domain::research::ResearchProjectionV1;
use crate::domain::search::{SearchProjectionFreshnessV1, SearchProjectionV1};
...
mod tests {
    use super::*;
    use crate::domain::capability::runtime::{
        CapabilitySourceFactV1, CapabilitySourceOwnerV1, CapabilitySubjectV1, build_capability_view,
    };
    use crate::domain::evidence::diagnostics::project_ordinary_diagnostics;
    use crate::domain::intake::IntakeLedgerV1;
    use crate::domain::maturity::build_maturity_view;
    use crate::domain::memory::MemoryLedgerV1;
    use crate::domain::research::ResearchLedgerV1;
    use crate::domain::search::{SearchIndexGenerationV1, SearchQueryV1, project_search};
