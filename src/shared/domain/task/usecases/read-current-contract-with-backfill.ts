...
// exists for the task, backfill the L2 store with version 1 first. This
// handles pre-fix repos where the L1 verbs wrote contracts but no L2 mirror
// existed.
...
// backfill version 1 and return [contract].
