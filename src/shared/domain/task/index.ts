// Legacy trust-pipeline task domain. Sibling product to the canonical task
// module (`src/types/task.ts`, `src/repo/task-store.port.ts`). Consumers that
// touch both shapes must alias `Task` and `TaskStorePort` explicitly.
