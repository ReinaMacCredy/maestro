...
- Chain 58 ECC skills to maestro lifecycle workflow
- Add ECC-derived quality gates and optional skillpack
...
- Add skill-creator package and update skill links/docs
...
- Add BR sync, skill detection, and family parity fixes
...
- Add deep discovery skill with BMAD-inspired workflow
...
- Restore index.md generation per track
...
- Reduce token waste across maestro skill family (~960 tokens)
...
- Add parallel mode reference doc
- Add --parallel flag to SKILL.md
- Integrate agent-mail file reservations into parallel mode
- Add CLAUDE.md to provide project context, tech stack, and operational guidance for Claude Code.
...
- Add BR/BV integration for structured task tracking (Phase A)
- Integrate BR tracking into implement skill (Phase B)
- Add BR integration to status, review, and revert skills (Phase C)
- Add BR awareness to orchestrator and session hook (Phase D)
...
- Add plan-maestro orchestrator SKILL.md
- Add plan-maestro planner reference prompt


### Changed


- Make skills root canonical and symlink .claude compatibility path


### Documentation


- Add plan:maestro to maestro trigger table


### Fixed


- Exclude .venv from markdown link and anchor validation
- Correct planner-prompt fencing and em dashes
- Normalize web-design-guidelines canonical skill
...
- Add web-design-guidelines skill, update hook script paths, and introduce test output HTML files.
...
- Add skill interoperability for auto-detecting and injecting skills
...
- Escape /work in mermaid diagram to fix rendering
...
- Agent Mail CLI-first with MCP lazy-load fallback
...
- Add ca/Ralph as first-class execution mode


### Documentation


- Rewrite all documentation to sync with current project
...
- Enhance ca workflow with Ralph best practices
...
- Expand DS pipeline from 8 to 10 phases


### Fixed


- Inject track path into Ralph prompt via sed substitution
...
- Complete restoration from Kraken corruption
