 ...
 * @param {string} sourceType - Source type for namespacing (e.g., 'plugin', 'personal')
 ...
 *
 * @param {string} skillName - Skill name (e.g., "conductor", "beads")
 * @param {string} pluginDir - Path to plugin skills directory
 * @param {string} personalDir - Path to personal skills directory
 * @returns {{skillFile: string, sourceType: string, skillPath: string} | null}
 */
function resolveSkillPath(skillName, pluginDir, personalDir) {
    // Try personal skills first (override plugin skills)
    if (personalDir) {
    ...
    // Try plugin skills
    if (pluginDir) {
        const pluginPath = path.join(pluginDir, skillName);
