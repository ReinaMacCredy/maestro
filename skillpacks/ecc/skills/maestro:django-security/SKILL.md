---
name: maestro:django-security
description: "Django security best practices for authentication, CSRF, SQL injection, XSS prevention, and secure deployment. Use during maestro:review when reviewing Django security posture."
lifecycle: [review]
domain: [framework:django]
---
...
### Phase Guidance
**In maestro:review**: Apply security checklist during review phase. Verify CSRF protection, SQL injection prevention, XSS defenses, and authentication configuration.
