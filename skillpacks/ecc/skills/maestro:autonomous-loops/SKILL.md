---
name: maestro:autonomous-loops
description: "Patterns for autonomous Claude Code loops from simple pipelines to multi-agent DAG systems. Use during maestro:design when architecting automated workflows or multi-agent orchestration."
lifecycle: [design]
...
### Phase Guidance
**In maestro:design**: Reference loop architecture patterns when designing autonomous workflows. Choose appropriate complexity level (sequential, parallel, DAG) during architecture decisions.
