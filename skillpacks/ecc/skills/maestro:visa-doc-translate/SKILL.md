---
name: maestro:visa-doc-translate
description: "Translate visa application documents (images) to English and create bilingual PDFs. Use in any maestro phase when translating documents for visa applications."
...
### Phase Guidance
**In maestro:cross-cutting**: Apply document translation patterns when processing visa documents. Create bilingual PDF output with original and translation.
