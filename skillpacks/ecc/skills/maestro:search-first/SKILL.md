---
name: maestro:search-first
description: "Research-before-coding workflow. Use during maestro:design to find existing tools, libraries, and patterns before writing custom code."
lifecycle: [design]
domain: [practice:research]
---
...
### Phase Guidance
**In maestro:design**: Search for existing solutions before designing custom implementations. Check package registries, GitHub, and documentation first.
