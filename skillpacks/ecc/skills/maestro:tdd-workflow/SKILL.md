---
name: maestro:tdd-workflow
description: "Test-driven development workflow enforcing Red-Green-Refactor with 80%+ coverage. Use during maestro:implement as the core TDD methodology for all code changes."
lifecycle: [implement]
domain: [practice:tdd]
---
...
### Phase Guidance
**In maestro:implement**: Apply TDD cycle during Red-Green-Refactor (Steps 6a.2-6a.4). Write failing tests first, implement to pass, then refactor for quality.
