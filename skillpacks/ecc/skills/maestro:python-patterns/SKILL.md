---
name: maestro:python-patterns
description: "Pythonic idioms, PEP 8 standards, type hints, and best practices for Python applications. Use during maestro:implement when writing Python code -- naming, structure, and idiomatic patterns."
lifecycle: [implement]
...
### Phase Guidance
**In maestro:implement**: Apply Pythonic patterns during Green phase. Use type hints, dataclasses, and PEP 8 conventions for clean Python implementations.
