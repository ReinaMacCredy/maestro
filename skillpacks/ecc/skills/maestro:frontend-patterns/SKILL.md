---
name: maestro:frontend-patterns
description: "React and Next.js frontend patterns for state management, performance optimization, and UI best practices. Use during maestro:implement when building UI components or client-side features."
lifecycle: [implement]
...
### Phase Guidance
**In maestro:implement**: Apply React patterns during component implementation. Use proper state management, memoization, and composition patterns.
