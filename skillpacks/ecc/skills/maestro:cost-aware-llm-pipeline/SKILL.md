---
name: maestro:cost-aware-llm-pipeline
description: "Cost optimization for LLM API usage with model routing, budget tracking, retry logic, and prompt caching. Use during maestro:implement when building LLM-powered features."
lifecycle: [implement]
...
### Phase Guidance
**In maestro:implement**: Apply cost-aware patterns when implementing LLM API calls. Route by task complexity, track token budgets, and use prompt caching where possible.
