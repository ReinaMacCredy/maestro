---
name: maestro:swift-actor-persistence
description: "Thread-safe data persistence using Swift actors with in-memory cache and file-backed storage. Use during maestro:implement when building persistence layers in Swift."
lifecycle: [implement]
...
### Phase Guidance
**In maestro:implement**: Apply actor-based persistence when implementing data storage. Use actors to eliminate data races by design with file-backed caching.
