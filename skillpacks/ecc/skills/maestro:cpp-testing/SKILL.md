---
name: maestro:cpp-testing
description: "C++ testing with GoogleTest and CTest, coverage analysis, and sanitizers. Use during maestro:implement when writing C++ tests and maestro:review when checking C++ test coverage."
...
### Phase Guidance
**In maestro:implement**: Apply during Red phase for C++ tests. Use GoogleTest assertions, TYPED_TEST for generic code, and CTest for integration.
**In maestro:review**: Verify test coverage with gcov/lcov. Check sanitizer configurations and test organization during review.
