---
name: maestro:springboot-verification
description: "Verification loop for Spring Boot: build, static analysis, tests with coverage, security scans, and diff review. Use during maestro:review before Spring Boot releases or PRs."
lifecycle: [review]
...
### Phase Guidance
**In maestro:review**: Run full verification loop: build check, static analysis, test suite with coverage, security scan, and diff review.
