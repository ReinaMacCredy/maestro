---
name: maestro:security-review
description: "Comprehensive security checklist for authentication, input handling, secrets, API endpoints, and sensitive data. Use during maestro:review for security posture assessment."
lifecycle: [review]
domain: [practice:security]
---
...
### Phase Guidance
**In maestro:review**: Apply security checklist during review dimensions (Step 6). Check secrets management, input validation, authentication, and data protection.
