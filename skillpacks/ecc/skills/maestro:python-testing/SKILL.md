---
name: maestro:python-testing
description: "Python testing with pytest, TDD methodology, fixtures, mocking, and parametrization. Use during maestro:implement when writing Python tests following TDD."
lifecycle: [implement]
...
### Phase Guidance
**In maestro:implement**: Apply during Red phase (Step 6a.2) for Python tests. Use pytest fixtures, parametrize for edge cases, and mock external dependencies.
