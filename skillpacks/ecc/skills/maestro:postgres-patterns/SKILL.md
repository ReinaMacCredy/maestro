---
name: maestro:postgres-patterns
description: "PostgreSQL query optimization, schema design, indexing, and security patterns. Use during maestro:implement when writing SQL queries or designing database schemas with PostgreSQL."
lifecycle: [implement]
...
### Phase Guidance
**In maestro:implement**: Apply PostgreSQL patterns during database implementation tasks. Use proper indexing, query optimization, and RLS policies.
