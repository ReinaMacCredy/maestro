---
name: maestro:verification-loop
description: "Comprehensive post-change verification system with build, test, lint, and quality gates. Use during maestro:review as the core verification workflow before PRs or releases."
lifecycle: [review]
...
### Phase Guidance
**In maestro:review**: Run verification loop as final review gate. Execute build verification, test suite, linting, and quality checks in sequence.
