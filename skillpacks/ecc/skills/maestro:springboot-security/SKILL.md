---
name: maestro:springboot-security
description: "Spring Security best practices for authentication, authorization, CSRF, secrets, and rate limiting. Use during maestro:review when reviewing Spring Boot security configuration."
lifecycle: [review]
...
### Phase Guidance
**In maestro:review**: Apply Spring Security checklist during review. Verify authentication config, authorization rules, CSRF protection, and dependency security.
