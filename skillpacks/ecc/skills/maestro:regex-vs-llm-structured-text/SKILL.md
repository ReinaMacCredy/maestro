---
name: maestro:regex-vs-llm-structured-text
description: "Decision framework for choosing regex vs LLM for structured text parsing. Use during maestro:design when planning text extraction approach, and maestro:implement when building parsers."
lifecycle: [design, implement]
domain: [practice:decision]
---
...
### Phase Guidance
**In maestro:design**: Use decision framework to choose parsing approach during architecture. Start with regex for structured patterns, reserve LLM for edge cases.
**In maestro:implement**: Apply the chosen strategy during parser implementation. Build hybrid pipeline if needed.
