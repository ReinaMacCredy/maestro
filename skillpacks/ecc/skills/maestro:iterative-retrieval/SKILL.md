---
name: maestro:iterative-retrieval
description: "Progressive context retrieval pattern for multi-agent workflows. Use during maestro:design when architecting subagent context strategies or RAG-like retrieval pipelines."
lifecycle: [design]
...
### Phase Guidance
**In maestro:design**: Apply iterative retrieval when designing multi-agent context flow. Avoid upfront context loading -- design progressive refinement instead.
