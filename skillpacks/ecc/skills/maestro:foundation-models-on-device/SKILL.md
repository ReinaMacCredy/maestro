---
name: maestro:foundation-models-on-device
description: "Apple FoundationModels framework for on-device LLM with guided generation and tool calling in iOS 26+. Use during maestro:implement when building on-device ML features for Apple platforms."
lifecycle: [implement]
domain: [ai:apple-ml]
---
...
### Phase Guidance
**In maestro:implement**: Apply FoundationModels patterns when implementing on-device LLM features. Use @Generable for structured output and snapshot streaming for UI.
