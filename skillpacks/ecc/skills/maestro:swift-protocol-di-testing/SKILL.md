---
name: maestro:swift-protocol-di-testing
description: "Protocol-based dependency injection for testable Swift code with mock strategies and Swift Testing. Use during maestro:implement when writing testable Swift with DI."
lifecycle: [implement]
...
### Phase Guidance
**In maestro:implement**: Apply protocol-based DI during Red and Green phases. Define protocols for dependencies, inject via init, create mocks for testing.
