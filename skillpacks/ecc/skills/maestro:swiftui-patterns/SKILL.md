---
name: maestro:swiftui-patterns
description: "SwiftUI architecture with @Observable state management, view composition, navigation, and performance optimization. Use during maestro:implement when building SwiftUI views and features."
lifecycle: [implement]
...
### Phase Guidance
**In maestro:implement**: Apply SwiftUI patterns during UI implementation. Use @Observable for state, proper view composition, and navigation patterns.
