---
name: maestro:database-migrations
description: "Database migration best practices for schema changes, rollbacks, and zero-downtime deployments across PostgreSQL, MySQL, and ORMs. Use during maestro:implement when modifying database schemas."
lifecycle: [implement]
...
### Phase Guidance
**In maestro:implement**: Apply migration patterns during schema change tasks. Write reversible migrations, test rollbacks, and ensure zero-downtime compatibility.
