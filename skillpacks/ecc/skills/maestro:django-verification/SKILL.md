---
name: maestro:django-verification
description: "Verification loop for Django: migrations, linting, tests with coverage, security scans, and deployment readiness. Use during maestro:review before Django releases or PRs."
lifecycle: [review]
...
### Phase Guidance
**In maestro:review**: Run full verification loop: check migrations, run linter, execute tests with coverage, scan for security issues, verify deployment readiness.
