...
# Directory-aware label scoping for monorepos
...
- `sync.branch` - Name of the dedicated sync branch for beads data
...
Controls for the sync branch workflow:
