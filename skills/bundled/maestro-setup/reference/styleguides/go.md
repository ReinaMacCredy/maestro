# Google Go Style Guide Frozen Snapshot
...
- **Canonical**: Establishes prescriptive and enduring rules <span id="canonical"></span>
...
- **Normative**: Intended to establish consistency <span id="normative"></span>
...
- **Idiomatic**: Common and familiar <span id="idiomatic"></span>
...
- <span id="gotip"></span> Go Tip Episodes - stay tuned.

- <span id="unit-testing-practices"></span> Unit Testing Practices - stay tuned.
