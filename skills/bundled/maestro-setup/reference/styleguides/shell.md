# Google Shell Style Guide Frozen Snapshot
...
<span id="s1-background"></span>

## Background

<span id="s1.1-which-shell-to-use"></span>
...
<span id="s1.2-when-to-use-shell"></span>
...
<span id="s2-shell-files-and-interpreter-invocation"></span>

## Shell Files and Interpreter Invocation

<span id="s2.1-file-extensions"></span>
...
<span id="s3-environment"></span>

## Environment

<span id="s3.1-stdout-vs-stderr"></span>
...
<span id="s4-comments"></span>

## Comments

<span id="s4.1-file-header"></span>
...
<span id="s4.2-function-comments"></span>
...
<span id="s4.3-implementation-comments"></span>
...
<span id="s4.4-todo-comments"></span>
...
<span id="s5.2-line-length-and-long-strings"></span>
...
<span id="s5.4-control-flow"></span>

<span id="s5.4-loops"></span> <span id="loops"></span>
...
<span id="s5.5-case-statement"></span>
...
<span id="s5.6-variable-expansion"></span>
...
<span id="s6-features-and-bugs"></span>

## Features and Bugs

<span id="s6.1-shellcheck"></span>
...
<span id="s6.2-command-substitution"></span>
...
<span id="s6.4-testing-strings"></span>
...
<span id="s6.5-wildcard-expansion-of-filenames"></span>
...
<span id="s6.7.1-arrays-pros"></span>
...
<span id="s6.7.2-arrays-cons"></span>

#### Arrays Cons

Using arrays can risk a script’s complexity growing.

<span id="s6.7.3-arrays-decision"></span>
...
<span id="s6.8-pipes-to-while"></span>
...
<span id="s7-naming-conventions"></span>

## Naming Conventions

<span id="s7.1-function-names"></span>
...
<span id="s7.2-variable-names"></span>
...
<span id="s7.3-constants-and-environment-variable-names"></span> <span id="s7.5-read-only-variables"></span>
...
<span id="s7.4-source-filenames"></span>
...
<span id="s7.5-use-local-variables"></span> <span id="s7.6-use-local-variables"></span>
...
<span id="s7.6-function-location"></span> <span id="s7.7-function-location"></span>
...
<span id="s7.7-main"></span> <span id="s7.8-main"></span>
...
<span id="s8-calling-commands"></span>

## Calling Commands

<span id="s8.1-checking-return-values"></span>
...
<span id="s8.2-builtin-commands-vs-external-commands"></span>
