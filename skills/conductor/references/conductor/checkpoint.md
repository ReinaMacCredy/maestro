...
→ [Progress Checkpointing](../beads/workflow.md#progress-checkpointing)
...
→ [Degradation Signals](../beads/workflow.md#degradation-signals)
...
- [Session Lifecycle](../context-engineering/session-lifecycle.md) - RECALL/REMEMBER
