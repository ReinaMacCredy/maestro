...
Usage:
    uv run skills/beads/scripts/track_assigner.py <beads.json>
    uv run skills/beads/scripts/track_assigner.py <beads.json> --max-workers 4
    uv run skills/beads/scripts/track_assigner.py <beads.json> --json
"""
import argparse
import json
import sys
