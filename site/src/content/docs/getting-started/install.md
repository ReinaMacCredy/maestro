...
Supervisor, Lead, and Peer coordination requires Herdr for the room and lane
panes. Install Herdr separately:

```sh
curl -fsSL https://herdr.dev/install.sh | sh
```

Maestro remains the durable record. Herdr owns pane creation, agent lifecycle,
prompting, wake-up, and pane closure.
