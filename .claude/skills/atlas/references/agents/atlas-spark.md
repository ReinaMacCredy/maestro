---
name: atlas-spark
description: Quick fix specialist for Atlas. Small, focused changes under 10 lines.
...
## When NOT to Use Atlas-Spark

- Multi-file changes → Use atlas-kraken
