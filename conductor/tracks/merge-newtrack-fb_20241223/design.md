---
track_id: merge-newtrack-fb_20241223
created: 2024-12-23
status: approved
...
```json
{
  "trackId": "auth_20241223",
  "status": "complete | in_progress | failed",
  "lastVerified": "2024-12-23T10:00:00Z",
...
━━━ DESIGN COMPLETE ━━━
Track: auth_20241223
File: conductor/tracks/auth_20241223/design.md

Next: `/conductor-newtrack auth_20241223`
      (generates spec + plan + files beads + reviews)

Or:
  `/conductor-newtrack auth_20241223 --no-beads` — spec + plan only
```
...
━━━ TRACK COMPLETE ━━━
Track: auth_20241223
Spec: conductor/tracks/auth_20241223/spec.md
Plan: conductor/tracks/auth_20241223/plan.md
Beads: 5 epics, 23 issues filed and reviewed

Ready issues: 8
First task: bd-4 (Setup auth config)

Next: `Start epic bd-1` or `/conductor-implement auth_20241223`
```
